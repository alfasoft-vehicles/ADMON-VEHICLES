...
@Component({
  selector: 'app-operaciones-explicacion-cuentas-pagar',
  templateUrl: './operaciones-explicacion-cuentas-pagar.component.html',
  styleUrls: ['./operaciones-explicacion-cuentas-pagar.component.css'],
})
export class OperacionesExplicacionCuentasPagarComponent implements OnInit {
  explanation: string = '';
  valueDisplay: string = '';
  value: number = 0;

  constructor(
    public dialogRef: MatDialogRef<OperacionesExplicacionCuentasPagarComponent>,
